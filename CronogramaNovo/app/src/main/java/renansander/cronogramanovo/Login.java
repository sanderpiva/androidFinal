                    ...
                    if(idadeChecada>13){
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                pb.setVisibility(View.INVISIBLE);
                                Intent intent = new Intent(getBaseContext(), Cronograma.class);
                        ...
                        Toast.makeText(view.getContext(), "Lembrete da idade secreta: Quantos anos você tinha quando aprendeu a andar de bike?", Toast.LENGTH_SHORT).show();
                    }
